...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # 🔹 Instead of set_registry_uri, use dagshub.init()
            ...
            with mlflow.start_run():
                ...
                # ✅ This will automatically go to DagsHub’s MLflow tracking
...
#             mlflow.set_registry_uri("https://dagshub.com/Harika-Kancharla/mlproject.mlflow")
